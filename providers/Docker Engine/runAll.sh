...
#
# This script executes all computations on the Docker Engine dataset.
#
...
python ExtractDatasetURIs.py "${DATASETS_DIR}/Docker-APIs.csv" > "${DATASETS_DIR}/DatasetURIs.csv"
