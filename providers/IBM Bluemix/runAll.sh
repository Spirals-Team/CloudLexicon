...
#
# This script executes all computations on the IBM Bluemix dataset.
#
...
python ExtractDatasetURIs.py "${DATASETS_DIR}/IBM-Bluemix-APIs.csv" > "${DATASETS_DIR}/DatasetURIs.csv"
