...
#
# This script executes all computations on the Kubernetes dataset.
#
...
python ExtractDatasetURIs.py "${DATASETS_DIR}/Kubernetes-APIs.csv" > "${DATASETS_DIR}/DatasetURIs.csv"
