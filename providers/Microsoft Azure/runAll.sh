...
#
# This script executes all computations on the Microsoft Azure dataset.
#
...
python ExtractDatasetURIs.py "${DATASETS_DIR}/Microsoft-Azure-APIs.csv" > "${DATASETS_DIR}/DatasetURIs.csv"
