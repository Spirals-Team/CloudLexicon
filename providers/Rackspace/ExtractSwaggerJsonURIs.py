...
#
# This script generates the list of URIs where the Swagger JSON documentation for Rackspace is.
# 

from cloudlex import extraction

extraction.extractCsvFileOfSwaggerJsonURIsFromRackerlabs('rackspace')
