...
#
# This script executes all computations on the Cloud Foundry dataset.
#
...
python ExtractDatasetURIs.py "${DATASETS_DIR}/Cloud-Foundry-APIs.csv" > "${DATASETS_DIR}/DatasetURIs.csv"
